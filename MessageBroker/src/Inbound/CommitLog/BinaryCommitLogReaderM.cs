...
public sealed class BinaryCommitLogReaderM : ICommitLogReaderM
{
    ...
    private ILogSegmentReaderM? _activeSegmentReader;
    private ulong _currentSegmentBaseOffset;
    private readonly ConcurrentDictionary<ulong, ILogSegmentReaderM> _inactiveSegmentReaders = new();

    public BinaryCommitLogReaderM(ILogSegmentFactory segmentFactory, ITopicSegmentRegistry segmentRegistry)
    {
    ...
    private void RefreshSegmentReader()
    {
        ...
        if (_activeSegmentReader == null || _currentSegmentBaseOffset != activeSegment.BaseOffset)
        {
            ...
            _activeSegmentReader = _segmentFactory.CreateReaderM(activeSegment);
    ...
    private ILogSegmentReaderM GetOrCreateSegmentReader(LogSegment segment)
    {
        return _inactiveSegmentReaders.GetOrAdd(segment.BaseOffset, (_) => _segmentFactory.CreateReaderM(segment));
    }
}