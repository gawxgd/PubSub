...
public sealed class CommitLogFactoryM(
    ...
    : ICommitLogFactoryM, IAsyncDisposable
{
    ...
    private readonly ConcurrentDictionary<string, ICommitLogReaderM> _readers = new();
    ...
    public ICommitLogReaderM GetReader(string topic)
    {
    ...
    private ICommitLogReaderM CreateReader(string topic)
    {
        var topicOpt = _commitLogTopicOptions
            .FirstOrDefault(t => string.Equals(t.Name, topic, StringComparison.OrdinalIgnoreCase));
        ...
        return new BinaryCommitLogReaderM(segmentFactory, manager);
    }
