Feature: Schema Registry compatibility enforcement
    ...
    Scenario: FULL accepts adding a new field with default (new schema registration succeeds)
        Given publisher oldSchemaPublisher of type "TestEvent" is configured with the following options:
            | Setting             | Value          |
            | topic               | test-topic     |
            | Broker              | 127.0.0.1:9096 |
            ...
            | Max Retry Attempts  | 3              |
            | Max Send Attempts   | 3              |
        And publisher newSchemaPublisher of type "TestEventWithAdditionalDefaultField" is configured with the following options:
            | Setting             | Value          |
            | topic               | test-topic     |
            | Broker              | 127.0.0.1:9096 |
            | Queue Size          | 1000           |
    ...
    @schemaRegistryMode_FULL
    Scenario: FULL accepts removing a field that has default (new schema registration succeeds)
        Given publisher oldSchemaPublisher of type "TestEventWithAdditionalDefaultField" is configured with the following options:
            | Setting             | Value          |
            | topic               | test-topic     |
            | Broker              | 127.0.0.1:9096 |
            | Queue Size          | 1000           |
    ...
    @schemaRegistryMode_FULL
    Scenario: FULL rejects adding a required field without default (new schema registration fails)
        Given publisher oldSchemaPublisher of type "TestEvent" is configured with the following options:
            | Setting             | Value          |
            | topic               | test-topic     |
            | Broker              | 127.0.0.1:9096 |
    ...
    @schemaRegistryMode_FULL
    Scenario: FULL rejects removing a required field without default (new schema registration fails)
        Given publisher oldSchemaPublisher of type "TestEventWithAdditionalField" is configured with the following options:
            | Setting             | Value          |
            | topic               | test-topic     |
            | Broker              | 127.0.0.1:9096 |
