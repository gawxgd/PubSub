...
#line hidden
            ...
            else
            {
                ...
                table47.AddRow(new string[] {
                            ...
                            "3"});
#line 7
        await testRunner.GivenAsync("a publisher is configured with the following options:", ((string)(null)), table47, "Given ");
#line hidden
#line 14
...
#line hidden
                ...
                table48.AddRow(new string[] {
                            ...
                            "3"});
#line 15
        await testRunner.AndAsync("subscriber S1 is configured starting at offset 11 with the following options:", ((string)(null)), table48, "And ");
#line hidden
                ...
                table49.AddRow(new string[] {
                            ...
                            "3"});
#line 21
        await testRunner.AndAsync("subscriber S2 is configured starting at offset 5 with the following options:", ((string)(null)), table49, "And ");
#line hidden
#line 27
...
#line hidden
                ...
                table50.AddRow(new string[] {
                            "m11"});
#line 29
        await testRunner.AndAsync("subscriber S2 should receive messages \"msg5\" to \"m11\":", ((string)(null)), table50, "And ");
#line hidden
            }
