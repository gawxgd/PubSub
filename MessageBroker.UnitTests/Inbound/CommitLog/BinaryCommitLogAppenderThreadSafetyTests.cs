...
//             .ToList();
//
//         allOffsets.Should().HaveCount(taskCount);
//         allOffsets.Should().OnlyHaveUniqueItems("each record should have unique offset");
//         allOffsets.Should().BeInAscendingOrder("offsets should be sequential");
//     }
//
//     [Fact]
