...
public class Program
{
    public static void Main(string[] args)
    {
        ...
        var schemaRegistryUrl = Environment.GetEnvironmentVariable("SCHEMA_REGISTRY_URL") ?? "http:
        ...
        Console.WriteLine($"  Publisher broker:   messageBroker:
        Console.WriteLine($"  Subscriber broker:  messageBroker:
